CREATE DATABASE `spa-co_web_2014_100K`;

USE spa-co_web_2014_100K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=131166 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=93159 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'spa-co_web_2014_100K-sources.txt' INTO TABLE sources;
